...
Par exemple, lors de la création du portefeuille avec [StarBase wallet](https://deploystarship.com) l'utilisateur obtient une seule clé privée pour 5 crypto-monnaies:
